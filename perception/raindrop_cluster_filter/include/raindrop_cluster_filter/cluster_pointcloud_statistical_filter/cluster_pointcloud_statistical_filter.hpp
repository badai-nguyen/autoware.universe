...
#ifndef RAINDROP_CLUSTER_FILTER__CLUSTER_POINTCLOUD_STATISTICAL_FILTER__CLUSTER_POINTCLOUD_STATISTICAL_FILTER_HPP_
#define RAINDROP_CLUSTER_FILTER__CLUSTER_POINTCLOUD_STATISTICAL_FILTER__CLUSTER_POINTCLOUD_STATISTICAL_FILTER_HPP_
...
class ClusterPointcloudStatisticalFilter : public rclcpp::Node
{
public:
  explicit ClusterPointcloudStatisticalFilter(const rclcpp::NodeOptions & node_options);

private:
  void objectCallback(
    const tier4_perception_msgs::msg::DetectedObjectsWithFeature::ConstSharedPtr input_msg);
  bool isValidatedCluster(const sensor_msgs::msg::PointCloud2 & cluster, const geometry_msgs::msg::Pose & base_link_origin);
...
#endif  // RAINDROP_CLUSTER_FILTER__CLUSTER_POINTCLOUD_STATISTICAL_FILTER__CLUSTER_POINTCLOUD_STATISTICAL_FILTER_HPP_
