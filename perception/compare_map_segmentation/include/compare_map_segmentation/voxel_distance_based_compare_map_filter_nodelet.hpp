...
public:
  ...
  : VoxelGridStaticMapLoader(node, leaf_size, z_size_reduce_ratio, tf_map_input_frame, mutex)
  {
...
public:
  ...
  : VoxelGridDynamicMapLoader(
      node, leaf_size, z_size_reduce_ratio, tf_map_input_frame, mutex, main_callback_group)
  {
