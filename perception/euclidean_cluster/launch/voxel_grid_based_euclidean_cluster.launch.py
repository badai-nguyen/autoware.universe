...
def launch_setup(context, *args, **kwargs):
    ...
    long_range_crop_box_filter_component = ComposableNode(
        ...
        remappings=[
            ("input","downsampled/pointcloud"),
            ("output","downsampled/long_range/pointcloud"),
        ],
        parameters=[
            {
                "min_x": -70.0,
    ...
    outlier_filter_component = ComposableNode(
        ...
        name="outlier_filter",
        remappings=[("input", "downsampled/short_range/pointcloud"), ("output", "outlier_filter/pointcloud")],
    ...
    downsample_concat_component = ComposableNode(
        ...
        parameters=[
            {
                "input_topics": ["downsampled/long_range/pointcloud","outlier_filter/pointcloud"],
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[long_range_crop_box_filter_component,short_range_crop_box_filter_component,outlier_filter_component,downsample_concat_component, euclidean_cluster_component],
        output="screen",
    )
