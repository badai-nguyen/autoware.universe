...
std::vector<pcl::PointIndices> FEC(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, unsigned long min_component_size, double tolorance, int max_n) {
    ...
    unsigned long cloud_size = cloud->size();
