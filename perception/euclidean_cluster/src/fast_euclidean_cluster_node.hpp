...
{
class FastEuclideanClusterNode : public rclcpp::Node
{
private:
  ...
  std::shared_ptr<FastEuclideanCluster> cluster_;

public:
  explicit FastEuclideanClusterNode(const rclcpp::NodeOptions & options);
};
